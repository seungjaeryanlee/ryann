...
"""
Tests the function nn.shallow._backward_propagation().
"""
import numpy as np
...
def test_nn_backward_propagation_gradient_checking():
    """
    Test output of nn.shallow._backward_propagation() with Gradient Checking. Gradient Checking is
    a method of manually computing derivatives and comparing it with the output.
    """
    n_x = 3
    n_h = 3
    n_y = 1
