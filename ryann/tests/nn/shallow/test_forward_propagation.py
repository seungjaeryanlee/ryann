...
"""
Tests the function nn.shallow._forward_propagation().
"""
import numpy as np
...
def test_nn_forward_propagation_dimension():
    """
    Checks the dimensions of output values of nn.shallow._forward_propagation().
    """
...
def test_nn_forward_propagation_precomputed():
    """
    Tests nn.shallow._forward_propagation() with weight matrices and bias vectors with precomputed
    results.
    """
    pass
