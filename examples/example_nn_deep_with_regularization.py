...
# 3) Train regularizaed model
parameters, costs = deep.train(X, Y, layers=[2, 10, 10, 10, 10, 10, 10, 1],
                               num_iter=2000, learning_rate=0.01, regularization=True, lambd=1)
